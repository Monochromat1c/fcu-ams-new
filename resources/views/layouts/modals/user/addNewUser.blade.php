        ...
        <div class="relative bg-white rounded-lg shadow-lg dark:bg-white border border-slate-400">
            ...
            <div class="p-6 text-center">
                ...
                <form class="login-form rounded-lg"
                    action="{{ route('user.add') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="grid grid-cols-2 gap-3">
                        <div class="mb-2 col-span-2">
                            <label for="profile_picture" class="text-left block text-gray-700 font-bold mb-2">Profile
                                Picture:</label>
                            <input type="file" id="profile_picture" name="profile_picture"
                                class="w-full border rounded-md bg-gray-100">
                        </div>
                        <div class="mb-2">
                            <label for="first_name" class="text-left block text-gray-700 font-bold mb-2">First Name:</label>
                            <input type="text" id="first_name" name="first_name" class="w-full p-2 border rounded-md bg-gray-100"
                                required>
                        </div>
                        <div class="mb-2">
                            <label for="middle_name" class="text-left block text-gray-700 font-bold mb-2">Middle Name:</label>
                            <input type="text" id="middle_name" name="middle_name" class="w-full p-2 border rounded-md bg-gray-100">
                        </div>
                        <div class="mb-2">
                            <label for="last_name" class="text-left block text-gray-700 font-bold mb-2">Last Name:</label>
                            <input type="text" id="last_name" name="last_name" class="w-full p-2 border rounded-md bg-gray-100"
                                required>
                        </div>
                        <div class="mb-2">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text" id="address" name="address" class="w-full p-2 border rounded-md bg-gray-100"
                                required>
                        </div>
                        <div class="mb-2">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="email" id="email" name="email" class="w-full p-2 border rounded-md bg-gray-100" required>
                        </div>
                        <div class="mb-2">
                            <label for="username" class="text-left block text-gray-700 font-bold mb-2">Username:</label>
                            <input type="text" id="username" name="username" class="w-full p-2 border rounded-md bg-gray-100"
                                required>
                        </div>
                        <div class="mb-2">
                            <label for="password" class="text-left block text-gray-700 font-bold mb-2">Password:</label>
                            <input type="password" id="password" name="password" class="w-full p-2 border rounded-md bg-gray-100"
                                required>
                        </div>
                        <div class="mb-4">
                            <label for="password_confirmation" class="text-left block text-gray-700 font-bold mb-2">Confirm
                                Password:</label>
