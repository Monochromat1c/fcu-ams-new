                            ...
                            <div class="flex justify-between items-center">
                                ...
                                @if($action['type'] === 'Asset')
                                    ...
                                    @elseif($action['action'] === 'removed')
                                        <svg xmlns="http://www.w3.org/2000/svg" class="size-5 text-red-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    <span class="ml-3 text-sm text-gray-500">{{ $action['date'] }}</span>
                                </div>
                            </div>
                        </div>
                    @endforeach
