<div id="add-site-modal" style="min-height:100vh;" tabindex="-1" aria-hidden="true"
    ...
    <div class="relative my-auto mx-auto p-4 w-full max-w-2xl h-full md:h-auto">
        ...
        <div class="relative bg-white rounded-lg shadow-lg dark:bg-white border border-slate-400">
            ...
            <div class="p-6 text-center">
                ...
                <form method="POST" action="{{ route('site.add') }}">
                    @csrf
                    <div class="mb-4">
                        <input type="text" id="site" name="site" class="w-full p-2 bg-gray-100 border rounded-md"
                            required>
                    </div>
