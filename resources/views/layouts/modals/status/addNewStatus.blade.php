        ...
        <div class="bg-white rounded-xl shadow-2xl border border-gray-200 relative">
            ...
            <div class="p-8 space-y-6">
                <div class="text-center">
                    <h2 class="text-2xl font-bold text-gray-800 mb-2">Add New Status</h2>
                </div>
                <form method="POST" action="{{ route('status.add') }}" class="space-y-4">
                    @csrf
                    <div>
                        <label for="status" class="block text-sm font-medium text-gray-700 mb-2">Status Name</label>
