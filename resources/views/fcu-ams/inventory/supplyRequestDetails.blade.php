                ...
                <div>
                    ...
                    <div class="space-y-3">
                        ...
                        <div>
                            ...
                            <span class="ml-2">₱{{ number_format($totalValue, 2) }}</span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead>
                            <tr class="bg-gradient-to-r from-blue-400 to-blue-500 text-white">
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider">Unit Price</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach($requests as $request)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        ₱{{ number_format($request->quantity * $request->inventory->unit_price, 2) }}
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
