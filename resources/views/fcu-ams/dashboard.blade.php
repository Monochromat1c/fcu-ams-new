        ...
        <div class="m-3 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <a href="{{ route('inventory.list') }}">
                <div class="bg-white rounded-lg shadow-md p-6">
                    <div class="flex items-center mb-2">
                        ...
                        <h3 class="text-lg inline-block font-semibold my-auto whitespace-nowrap">Total Inventory Supplies</h3>
                    </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                <div class="flex align-items-center mb-2">
                    ...
                    <h3 class="text-lg font-semibold my-auto whitespace-nowrap">Total Inventory Value</h3>
                </div>
