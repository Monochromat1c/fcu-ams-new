        ...
        <div class="content-area mx-3">
            ...
            <div class="bg-white rounded-lg shadow-md p-6 lowStock mb-3">
                ...
                <table class="table-auto w-full">
                    <thead>
                        <tr>
                            <th class="px-4 py-2 text-left bg-slate-200 border border-slate-400">ID</th>
            ...
            @if($inventories->isEmpty())
                <div class="bg-white rounded-lg shadow-md p-6 mb-3">
                    <div class="flex align-items-center flex-col">
                        ...
                        <p class="text-center text-xl text-gray-500">No supplies purchased within this week.</p>
                    </div>
                </div>
            @else
            ...
            @if($assets->isEmpty())
                <div class="bg-white rounded-lg shadow-md p-6 mb-3">
                    <div class="flex align-items-center flex-col">
                        <h2 class="text-2xl mb-2">Assets Purchased This Week</h2>
                        <p class="text-center text-xl text-gray-500">No assets purchased within this week.</p>
                    </div>
                </div>
            @else
                                ...
                                <ul class="pagination my-auto flex">
                                    ...
                                    <li class="page-item p-1 my-auto">
                                        <a class="page-link my-auto"
                                            href="{{ $lowStockInventories->previousPageUrl() }}">
