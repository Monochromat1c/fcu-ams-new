...
<div class="grid grid-cols-6">
    ...
    <div class="content min-h-screen bg-slate-100 col-span-5">
        ...
        <div class="bg-white p-5 shadow-md m-3 rounded-md">
            ...
            <form action="{{ route('departments.add.store') }}" method="POST">
                @csrf
                <div class="mb-3">
                ...
                <div class="space-x-2 flex">
                    <a href="{{ route('departments.list') }}" class="ml-auto rounded-md shadow-md px-5 py-2 bg-red-600 hover:shadow-md hover:bg-red-500
