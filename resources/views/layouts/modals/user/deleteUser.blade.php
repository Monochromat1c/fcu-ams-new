@foreach($users as $user)
    <div id="delete-user-modal{{ $user->id }}" style="min-height:100vh;" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative my-auto mx-auto p-4 w-full max-w-2xl h-full md:h-auto">
            ...
            <div class="relative bg-white rounded-lg shadow-lg dark:bg-white border border-slate-400">
                ...
                <div class="p-6 text-center" id="modal">
                    ...
                    <p class="my-2">Are you sure you want to delete the user "<span
                            class="text-red-800">{{ $user->first_name . ' ' . $user->last_name }}</span>"?
                            </p>
