                ...
                <div class="flex justify-between items-center">
                    <div class="flex items-center justify-between w-full">
                        ...
                        @if(auth()->user()->role->role == 'Viewer')
                            <button onclick="window.location.href='{{ route('inventory.supply.request.print', $requests->first()->request_group_id) }}'" class="invisible bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded inline-flex items-center">
