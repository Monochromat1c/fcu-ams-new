    ...
    <div class="content min-h-screen bg-slate-100 col-span-5">
        ...
        <div class="bg-white p-5 shadow-md m-3 rounded-md">
            <div class="flex justify-between mb-3">
                ...
                <div class="searchBox">
                    <form action="{{ route('departments.list') }}" method="GET" class=" flex gap-1">
                        <input type="text" name="search" placeholder="Search for departments..."
                    ...
                    <thead>
                        <tr>
                            <th class="px-4 py-2 text-left bg-slate-100 border border-slate-400">
                                <div class="flex">
                                    <a class="my-auto"
                                        href="{{ route('departments.list', ['sort' => 'id', 'direction' => ($direction == 'asc' && $sort == 'id') ? 'desc' : 'asc']) }}">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="1.5" stroke="currentColor" class="size-6">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                d="M3 7.5 7.5 3m0 0L12
                                                                                            7.5M7.5 3v13.5m13.5 0L16.5
                            ...
                            <th class="px-4 py-2 text-left bg-slate-100 border border-slate-400">
                                <div class="flex">
                                    <a class="my-auto"
                                        href="{{ route('departments.list', ['sort' => 'department', 'direction' => ($direction == 'asc' && $sort == 'department') ? 'desc' : 'asc']) }}">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="1.5" stroke="currentColor" class="size-6">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                            ...
                            <th class="px-4 py-2 text-left bg-slate-100 border border-slate-400">
                                <div class="flex">
                                    <a class="my-auto"
                                        href="{{ route('departments.list', ['sort' => 'date_added', 'direction' => ($direction == 'asc' && $sort == 'date_added') ? 'desc' : 'asc']) }}">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke-width="1.5" stroke="currentColor" class="size-6">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                d="M3 7.5 7.5 3m0 0L12 7.5M7.5 3v13.5m13.5 0L16.5 21m0 0L12 16.5m4.5 4.5V7.5" />
